...
import './case_detail_overview_screen.dart';
import 'dart:io';
import 'package:image_picker/image_picker.dart';

class ClientApplyForRequestScreen extends StatefulWidget {
  String id;
  ClientApplyForRequestScreen(this.id);
  @override
  _ClientApplyForRequestScreenState createState() => _ClientApplyForRequestScreenState();
}

class _ClientApplyForRequestScreenState extends State<ClientApplyForRequestScreen> {
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => ClientCaseDetailOverviewScreen(widget.id,_nameController.text.toString(),
