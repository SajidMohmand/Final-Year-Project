...
class LawyerChatbotScreen extends StatefulWidget {
  @override
  _LawyerChatbotScreenState createState() => _LawyerChatbotScreenState();
}

class _LawyerChatbotScreenState extends State<LawyerChatbotScreen> {
